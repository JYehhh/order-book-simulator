...
SERVER_OBJS = $(BUILD_DIR)/FilledTrade.o $(BUILD_DIR)/Order.o $(BUILD_DIR)/OrderIdGenerator.o \
              $(BUILD_DIR)/OrderBook.o $(BUILD_DIR)/OrderBookProcessor.o $(BUILD_DIR)/Server.o \
              $(BUILD_DIR)/TradeNotifier.o $(BUILD_DIR)/UserSession.o $(BUILD_DIR)/OrderJsonDecoder.o \
              $(BUILD_DIR)/OrderJsonEncoder.o

CLIENT_OBJS = $(BUILD_DIR)/Client.o $(BUILD_DIR)/OrderJsonEncoder.o
